...
| product_name        | VARCHAR(100)  | Descriptive name of the product, including key details such as type, color, and size.                |
...
| sales_amount    | DECIMAL       | The total monetary value of the sale for the line item, in whole currency units (e.g., 25).   |
| quantity        | INT           | The number of units of the product ordered for the line item (e.g., 1).                       |
| price           | DECIMAL       | The price per unit of the product for the line item, in whole currency units (e.g., 25).      |
